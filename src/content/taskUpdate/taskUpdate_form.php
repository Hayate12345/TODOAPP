...
$sql = "SELECT * FROM task_all order by id = ?";
                ...
                <div class="forms">
                    <form action="./update.php" method="post">
                        <div class="box">
                            ...
                            <br>
                            <textarea required name="content" cols="30" rows="2"><?php echo $result['content'] ?></textarea>
                        </div>
                        ...
                        <input type="hidden" name="state" value="<?php echo $result['situation'] ?>">
                        <input type="hidden" name="ster" value="<?php echo $result['ster'] ?>">
